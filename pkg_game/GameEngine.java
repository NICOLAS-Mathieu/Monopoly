...
public class GameEngine {
    ...
    /**
     * Initialise l'ensemble des cartes chance et communauté du jeu
     */
    public void createCarte()
    {
        ...
        Carte vCarteCom14 = new Carte(0, -1, "Rendez-vous à la gare la plus proche. Si vous passez par la départ, recevez 200€", 11);
    ...
    /***
     * permet de créer le nombre de joueur souhaite et d'initialiser les nom de joueur
     * @param vNom
     */
        ...
        if (vPos == 2 || vPos == 17|| vPos==7 || vPos==22 || vPos ==36 || this.aAutorise)
        {
            ...
            if (vCarteTiree.getAction() == 4 || vCarteTiree.getAction() == 7) {
                ...
                if (!this.aCurrentPlayer.getCarteFreePrison().isEmpty()) {
                    ...
                    if(vNumCarte == 2) {this.aListChance.addLast(new Carte(0, -1, "Vous êtes libéré de prison. Cette carte peut être conservée jusqu'à ce qu'elle soit utilisée ou vendue.", 2));}
                    else {this.aListCom.addLast(new Carte(0, -1, "Vous êtes libéré de prison. Cette carte peut être conservée jusqu'à ce qu'elle soit utilisée ou vendue.", 6));}
                    this.aGui.println("");
                } else {
            ...
            //Retournez à Belleville sans passer par le depart
                ...
                for (int i = 0; i < this.aListJoueur.size(); i++)
                {
                    if (i != this.aPosJoueurActuel)
                    {
                        ...
                        if (vCurrentJoueur.getArgent() > 10)
                        {
                            ...
                            this.actualiseArgent();
                            this.aGui.println("Le joueur "+vCurrentJoueur.getNom()+" a donné 10 euros a "+this.aCurrentPlayer.getNom());
                        }
                        else {
            ...
            //Rendez-vous à la gare la plus proche. Si vous passez par la départ, recevez 200€
    ...
    /***
     * Cette fonction permet de choisir deux possibilité avec la carte communauté numero 13
     */
    public void choix()
    {
        if (this.aChoix == 1)
    ...
    /**
     * Cette fonction permet de lancer les dés.
     */
    public void lancer()
    {
        if(this.aPasAssez)
        {
            this.aGui.println("Il reste des dettes à rembourser");
        ...
        if (this.aCurrentPlayer.getDouble() == 3){
            ...
            {
                this.aGui.println("Vous avez une carte 'sortie de prison',");
                this.aGui.println("la carte a été utilisé, vous serez libre au prochain tour.");
                this.aGui.println("");
                this.aCurrentPlayer.outPrison();
                int vNumCarte = this.aCurrentPlayer.supCarteFreePrison();
                if(vNumCarte == 2) {this.aListChance.addLast(new Carte(0, -1, "Vous êtes libéré de prison. Cette carte peut être conservée jusqu'à ce qu'elle soit utilisée ou vendue.", 2));}
    ...
    /***
     * permet de faire avancer le joueur du nombre obtenu apres avoir lancé les dés
     */
    private void avancer()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                this.aGui.println("Vous avez passés 3 tours en prison, vous êtes libre au prochain tour.");
                this.aGui.println("");
            }
        }
    }//avancer()
    ...
    /***
     * permet de savoir qui a réaliser le plus gros score pour determiner qui commencera la partie
     * @return
     */
    ...
    private void descriptionPos()
    {
        ...
        if (vCurrentCase.getClass().equals(Rue.class))
        {
            ...
            //S'il y a un propriétaire
                ...
                if (j.getNom().equals(this.aCurrentPlayer.getNom())){
                    ...
                    this.aGui.println("avec les commandes ''maison'' + nombre de maison souhaitée");
        ...
        //Le joueur tombe sur une case chance ou communauté
        ...
        for(int i=0; i<aNbActuelJoueur; i++)
        {
            if(this.aListJoueur.get(i)==pJoueurRemboursant)
            {
                ...
                else
                {
                    ...
                    this.actualiseArgent();
                    this.aGui.println(pJoueurRemboursant.getNom() + " a bien remboursé ses dettes de " + this.aListDette.get(i));
                    this.aGui.println("");
    ...
    public void vendre(final String pNumProp, final Joueur pJoueur)
    {
        ...
        this.actualiseArgent();
        this.aGui.println("Vous avez reçu " + vArgent + " correspondant au prix d'hypothèque.");
        this.aGui.println("Vous pouvez peut être rembourser vos dettes maintenant.");
        this.aGui.println("Exemple : 'rembourser joueur2' (Si le joueur2 a des dettes)");
        this.aGui.println("");
    }

    /**
     * Compte l'argent total d'un joueur qui doit hypothéquer.
     * @param pJoueurFaillite
     * @return l'argent total du compte du joueur + l'argent correspondant au prix de ses propriétés
     */
    ...
    /**
     * Libère les biens du joueur ayant fait faillite et vérifie si la partie se termine ou non
     * @param pJoueurFaillite
     */
    ...
    private void test(final Command pCommand)
    {
        ...
        catch (final FileNotFoundException pProblème)
